...
class XHolidayDb {
    ...
    public static final Integer[] HOLIDAY_2020 = {0x3000, 0x1012, 0x2017, 0x3018, 0x3019, 0x301a, 0x201b, 0x201c, 0x201d, 0x201e, 0x3303, 0x2305, 0x1319, 0x3400, 0x2403, 0x2404, 0x1408, 0x3518, 0x2519, 0x151b, 0x181a, 0x3900, 0x3901, 0x3902, 0x2904, 0x2905, 0x2906, 0x2907, 0x1909};

    static void print(@Nonnull Integer[] holiday) {
